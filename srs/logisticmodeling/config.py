...
CARGOS = {"Кофемашина": Cargo("Кофемашина", 8.0, 9.0, [600, 500, 600], "brown"),
          "Мультиварка": Cargo("Мультиварка", 14.0, 4.8, [550, 550, 550], "green"),
          "Микроволновая печь": Cargo("Микроволновая печь", 18.0, 19.5, [800, 700, 600], "gray")}
